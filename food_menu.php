...
<body>
  <section class="my-2 "
    style="background-image: url('img/b4.jpg');background-repeat:no-repeat;background-position:center;background-size:cover">
    <div class="py-5">
            ...
            <div class="col-md-4  py-3">
              <form action="codeuser.php" method="POST">
                <div class="card bg-secondary text-white">
                  <img class="set" src="./Admin/img/<?= $food_item['image'] ?>" width="50px" height="50px" alt="card image">
                  <div class="card-body">
                    ...
                    <div class="py-2">
                      ...
                      <button type="submit" name="add_to_cart_btn" class="btn btn-warning my-3">Add to Cart<i
