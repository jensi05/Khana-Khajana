...
<body
  style="background-image: url('img/b7.jpg');background-repeat:no-repeat;background-position:center;background-size:cover">
  ...
  <section class="my-2">
    <div class="py-2">
      ...
      <h2 class="text-center" style="font-size: 50px;">khana khajana Restaurant Services</h2>
    </div>
    <br>
