...
<body
  style="background-image: url('img/b3.jpg');background-repeat:no-repeat;background-position:center;background-size:cover; height:700px;">
                          ...
                          <td class="d-flex justify-content-center">
                            <div class="d-flex justify-content-center" style="width:130px">
                              <button type="button" class="input-group-text increment-btn"
                                onclick="increment('<?php echo $i; ?>')">+</button>
                              <input type="text" class="form-control input-qty  text-center" id="quantity<?php echo $i; ?>"
                                value="<?= $cart_item['quantity']; ?>" name="quantity<?= $i; ?>">
                              <button type="button" class="input-group-text decrement-btn"
                                onclick="decrement('<?php echo $i; ?>')">-</button>
                            </div>
                          </td>
