...
<footer class="bg-dark text-center text-white">
  ...
  <div class="container p-4">
    ...
    <section class="mb-4">
      <!-- Facebook -->
      <a class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/profile.php?id=100091131049190"
        role="button" target="_blank"><i class="fab fa-facebook-f"></i></a>
      <!-- Twitter -->
      <a class="btn btn-outline-light btn-floating m-1" href="https://twitter.com/KhanaKh92619828" role="button"
        target="_blank"><i class="fab fa-twitter"></i></a>
      <!-- Instagram -->
      <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/khana_khajana08/" role="button"
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
              ...
              <div class="d-flex justify-content-start flex-column align-items-start">
                <div class="gmap_canvas">
                  <iframe width="650" height="150" id="gmap_canvas"
                    src="https://maps.google.com/maps?q=Khana Khazan&t=&z=10&ie=UTF8&iwloc=&output=embed" frameborder="0"
                    scrolling="no">
                  </iframe>
                </div>
              </div>
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    <h4 style="color:white; ">2025 KhanaKhajana Resturant. All Rights Reserved.</h4>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->